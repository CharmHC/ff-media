...
> **Status:** Living document · **Version:** 0.15 · **Last updated:** 2026-07-12
>
...
> The **layout, the drag gestures and the dark-mode rendering are pending a user visual check**:
> `FFMedia.Tests` does not reference the WinExe, so XAML is verifiable only by build + human eye
> (see Changelog 0.15).
